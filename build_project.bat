...
xcopy /Y /I "%PROJECT_DIR%\include" "%BUILD_DIR%\include"
if errorlevel 1 (
...
cl /nologo /c99 /I"%BUILD_DIR%\include" /Fe"%BUILD_DIR%\main_test.exe" "%PROJECT_DIR%\main_test.c"
if errorlevel 1 (
